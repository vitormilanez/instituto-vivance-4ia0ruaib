          ...
          <article className="vivance-panel rounded-2xl p-5 sm:p-6" aria-labelledby="next-consultation-title">
            ...
            <div className="mt-6 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              ...
              <button
                ...
                className="vivance-primary-action inline-flex min-h-14 shrink-0 cursor-pointer items-center justify-center gap-3 rounded-xl px-6 text-sm font-bold text-white transition-colors sm:text-base"
              >
